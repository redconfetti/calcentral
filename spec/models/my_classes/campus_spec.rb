describe MyClasses::Campus do
      ...
      '2019-B' => [
        {
          ...
          dept: 'COMPSCI',
          dept_code: 'COMPSCI',
          id: 'compsci-189-2019-B',
          slug: 'compsci-189',
          academicCareer: 'UGRD',
          courseCareerCode: 'UGRD',
          requirementsDesignationCode: nil,
          term_yr: '2019',
          term_cd: 'B',
          term_id: '2192',
          session_code: nil,
          ...
          sections: [
            {
              ...
              session_id: '1',
              instructors: [
                {:name=>"Jonathan Shewchuk", :role=>"PI", :gradeRosterAccess=>"A", :uid=>"110169", :printInSchedule=>"Y"}
              ],
              :schedules=>{
                :oneTime=>[],
                :recurring=>[
                  {:buildingName=>"Wheeler", :roomNumber=>"150", :schedule=>"MW 6:30P-7:59P"}
                ]
              },
              :units=>#<BigDecimal:40941b54,'4.0',1(4)>,
              :grading=>{
                :grade=>"NP",
                :gradingBasis=>"EPN",
                :gradePoints=>#<BigDecimal:49e3b86b,'0.0',1(4)>,
                :gradePointsAdjusted=>#<BigDecimal:64b262a7,'0.0',1(4)>,
                :gradingLapseDeadline=>nil,
  ...
  :sections=>[
    {:ccn=>"28076", :instruction_format=>"LEC", :is_primary_section=>true, :section_label=>"LEC 001", :section_number=>"001", :topic_description=>nil, :session_id=>"1", :instructors=>[{:name=>"Jonathan Shewchuk", :role=>"PI", :gradeRosterAccess=>"A", :uid=>"110169", :printInSchedule=>"Y"}], :schedules=>{:oneTime=>[], :recurring=>[{:buildingName=>"Wheeler", :roomNumber=>"150", :schedule=>"MW 6:30P-7:59P"}]}, :units=>#<BigDecimal:40941b54,'4.0',1(4)>, :grading=>{:grade=>"NP", :gradingBasis=>"EPN", :gradePoints=>#<BigDecimal:49e3b86b,'0.0',1(4)>, :gradePointsAdjusted=>#<BigDecimal:64b262a7,'0.0',1(4)>, :gradingLapseDeadline=>nil, :gradingLapseDeadlineDisplay=>false, :includeInGpa=>"N"}},
    {:ccn=>"28846", :instruction_format=>"DIS", :is_primary_section=>false, :section_label=>"DIS 999", :section_number=>"999", :topic_description=>nil, :associated_primary_id=>"28076", :instructors=>[], :schedules=>{:oneTime=>[], :recurring=>[]}, :units=>#<BigDecimal:34d776eb,'0.0',1(4)>, :grading=>{:grade=>"", :gradingBasis=>nil, :gradePoints=>#<BigDecimal:27aa700,'0.0',1(4)>, :gradePointsAdjusted=>#<BigDecimal:d15f98a,'0.0',1(4)>, :gradingLapseDeadline=>nil, :gradingLapseDeadlineDisplay=>false, :includeInGpa=>"N"}}
  ],

  describe '#fetch' do
    it 'returns classes for current term'
    context 'when grading in progress term is present' do
      it 'returns grading in progress classes'
    end
  end
