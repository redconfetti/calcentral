describe User::Academics::Enrollment::Period do
  subject { build(:user_academics_enrollment_period) }
  ...
  describe '#to_json' do
    ...
    it 'returns hash representation for json' do
      ...
      expect(json_hash['beginTime']['unixTimestamp']).to eq 1586806200
      ...
      expect(json_hash['endTime']['unixTimestamp']).to eq 1592006340
